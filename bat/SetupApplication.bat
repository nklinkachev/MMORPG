...
:: Android packaging
set AND_CERT_NAME="MMORPGClient"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MMORPGClient.p12
...
set IOS_PROVISION=cert\MMORPGClient.mobileprovision
...
set APP_ID=air.MMORPGClient

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MMORPGClient
